/* SEO constants - the one place we set the canonical origin and brand
   ...
   SITE_URL env var when DNS for utahtechcalendar.com settles permanently. */

export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, "") ??
  "https://utahtechcalendar.com";

export const SITE_NAME = "Utah Tech Calendar";
...
export const ORGANIZATION_NAME = "Utah Tech Calendar";
